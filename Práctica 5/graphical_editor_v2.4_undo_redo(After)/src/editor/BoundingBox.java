 ...
 * las herramientas de creación (al menos, de las figuras predefinidas que se
 * proporcionan actualmente: rectángulo, círculo y triángulo). Así, la forma de
 * crear figuras consiste en, una vez seleccionada la herramienta de creación
 * del tipo de figura que se desee, hacer clic en un punto y arrastrar el ratón
 * hasta otra posición del dibujo. Cuando se suelte el botón del ratón se habrá
 * definido un área rectangular que será el que determine las dimensiones de la
 * figura a crear.<p>
 * 
...
public class BoundingBox 
{
	 ...
	 * uno de los movimientos previos, pero el objeto ya estaría creado  desde el principio. 
	 * 
	 ...
	 * izquierda así como el ancho y el alto que definen al rectángulo.
	 * 
